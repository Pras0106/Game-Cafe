...
<body class="bg-white text-black">
    ...
    <section class="w-full px-6 py-10 bg-gradient-to-br from-gray-600 via-gray-700 to-gray-600">
        ...
        <h2 class="text-2xl font-semibold mb-6 text-xl font-semibold mt-4 font-bold 
              ...
              hover:after:w-full">All PC Games</h2>
        ...
        <div class="relative">
            ...
            shadow-[0_4px_10px_rgba(0,0,0,0.7)]">
                    ...
                    <img src="image/ARC RAIDER.jpeg"
                        class="w-full h-auto object-cover rounded-lg mx-auto shadow-[0_4px_10px_rgba(0,0,0,0.7)]">
              ...
              after:content-[''] after:absolute after:left-0 after:-bottom-1 
              after:w-0 after:h-[3px] after:bg-lime-400 after:transition-all after:duration-300 
              hover:after:w-full"">Arc Raiders</h3>
            ...
            shadow-[0_4px_10px_rgba(0,0,0,0.7)]">
                    ...
                    <img src="image/Resident Evil Delux Edition.jpeg"
                        class="w-full h-auto object-cover rounded-lg mx-auto shadow-[0_4px_10px_rgba(0,0,0,0.7)]">
              ...
              after:content-[''] after:absolute after:left-0 after:-bottom-1 
              after:w-0 after:h-[3px] after:bg-lime-400 after:transition-all after:duration-300 
              hover:after:w-full"">Resident Evil Reuqiem Delux Edition</h3>
            ...
            shadow-[0_4px_10px_rgba(0,0,0,0.7)]">
                    ...
                    <img src="image/Sniper Elite Resistance.jpeg"
                        class="w-full h-auto object-cover rounded-lg mx-auto shadow-[0_4px_10px_rgba(0,0,0,0.7)]">
              ...
              after:content-[''] after:absolute after:left-0 after:-bottom-1 
              after:w-0 after:h-[3px] after:bg-lime-400 after:transition-all after:duration-300 
              hover:after:w-full"">Sniper Elite Resistance</h3>
    ...
    $sql = "SELECT * FROM komputer ORDER BY id_komputer ASC";
        ...
        <div id="flash-scroll" class="flex gap-6 overflow-x-auto scroll-smooth pb-4 no-scrollbar whitespace-nowrap">
            <?php if ($result && $result->num_rows > 0): ?>
                <?php while ($ps = $result->fetch_assoc()): ?>
                    <a href="detail_PC.php?id=<?= (int)$ps['id_komputer'] ?>" class="block min-w-[260px]">
                        <div class="min-w-[260px] bg-white border rounded-xl p-4 relative hover:shadow-lg">
                            <img src="<?= htmlspecialchars($ps['url_gambar']) ?>" class="w-full h-40 object-contain" alt="<?= htmlspecialchars($ps['tipe_pc']) ?>">
                            <h3 class="mt-3 font-semibold relative inline-block after:content-[''] after:absolute after:left-0 after:-bottom-1 after:w-0 after:h-[3px] after:bg-black after:transition-all after:duration-300 hover:after:w-full"><?= htmlspecialchars($ps['tipe_pc']) ?></h3>
                            <p class="text-red-500 font-bold">Rp <?= number_format($ps['harga_per_jam'], 0, ',', '.') ?> / jam</p>
                            <p class="text-gray-600 text-sm mt-1">Lokasi : Nomor <?= (int)$ps['id_komputer'] ?></p>
                            <div class="mt-2 font-semibold <?= $ps['status_komputer'] === 'Tersedia' ? 'text-green-600' : 'text-red-600' ?>">
                                <?= htmlspecialchars($ps['status_komputer']) ?>
                            </div>
                        </div>
                    </a>
                <?php endwhile; ?>
